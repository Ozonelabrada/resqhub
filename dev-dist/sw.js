...
define(['./workbox-f87553f6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/api\.cloudinary\.com\//, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/.*\.openstreetmap\.org\//, new workbox.CacheFirst({
    "cacheName": "map-tiles",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 100,
  ...
  workbox.registerRoute(/^https:\/\/photon\.komoot\.io\//, new workbox.NetworkFirst({
