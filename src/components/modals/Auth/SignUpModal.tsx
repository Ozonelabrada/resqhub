              ...
              <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                ...
                <div className="flex items-start gap-3 py-2">
                  ...
                  <label htmlFor="agreeToTerms" className="text-xs font-medium text-slate-500 leading-normal">
                    I agree to the <button type="button" className="text-orange-600 font-bold hover:underline">Terms of Service</button> and <button type="button" className="text-orange-600 font-bold hover:underline">Privacy Policy</button>.
                  </label>
                </div>
